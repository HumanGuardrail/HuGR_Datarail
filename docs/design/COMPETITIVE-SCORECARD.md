...
| **RAM to move data** (measured, same 51 MB/s) | ✅ **7 MB load · 3 MB idle** · 1.24 cores | ❌ 870 MB load · 275 MB idle · 1.49 cores | ❌ 1,757 MB load · 810 MB idle | ❌ ~256MB–1.5GB | **datarail — 124× (Kafka) / 251× (Pulsar) less RAM, CPU ~parity. The disruption axis: footprint, not speed. (`EFFICIENCY-TCO.md`)** |
