...
| **Max throughput** (OMB, 32-core, measured) | **624 MB/s** sealed (609k msg/s), p99 7ms | **1,604 MB/s** | 296–441 MB/s | ~38 MB/s (published) | **Kafka leads ~2.6×** (was 6.6× before I/O buffering — engineering closed most of it). datarail seals every msg + provider-blind; remaining gap is per-message hot-path, identified. (`OMB-RESULTS.md` Run 4.) |
