...
| **Max throughput** (OMB, 32-core, measured) | **658 MB/s** sealed (643k msg/s), p99 16ms | **1,604 MB/s** | 296–441 MB/s | ~38 MB/s (published) | **Kafka leads ~2.4×** (was 6.6× — I/O buffering on both sides closed most of it). Residual ceiling is the OMB framework, not datarail. Sealed + provider-blind throughout. (`OMB-RESULTS.md`.) |
