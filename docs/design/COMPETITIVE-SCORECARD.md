...
| **Max throughput** (32-core, measured) | **1403 MB/s** sealed @1KB (1.9 GB/s @16KB) — native driver; OMB client capped it at 658 | **1604 MB/s** (OMB, plaintext) | 296–441 MB/s (OMB) | ~38 MB/s (published) | **near-parity ~0.87× @1KB, datarail SEALED vs Kafka plaintext** (gap was 6.6×, now ~1.16×). Not 3-4× faster — honest. vs *encrypted* Kafka datarail would likely lead. (`OMB-RESULTS.md` Run 7.) |
