...
| **Max throughput** (OMB, 32-core, measured) | **232 MB/s** sealed (227k msg/s) | **1,534 MB/s** (1.5M msg/s) | 441 MB/s (430k msg/s) | ~38 MB/s (published) | **Kafka wins, decisively (6.6× datarail)** — brokers' home turf. datarail seals every msg + is provider-blind; raw GB/s was never its pitch. (`OMB-RESULTS.md` Run 3.) |
